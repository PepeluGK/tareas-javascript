...
const selectedPokemon = JSON.parse(getCookie("selectedPokemon"));
const userName = document.getElementById("userName");
const userImg = document.getElementById("userImg");

//comprobacion
if (selectedPokemon) {
    userName.textContent = selectedPokemon.name;
    userImg.src = selectedPokemon.img;
} else {
    userName.textContent = "No Pokémon seleccionado";
}

//pokemon rival aleatorio
...
rivalName.textContent = rivalPokemon.name;
rivalImg.src = rivalPokemon.img;

const battleButton = document.getElementById("battleButton");
battleButton.addEventListener("click", () => {
    document.cookie = `rivalPokemon=${JSON.stringify(rivalPokemon)}; path=/;`;
