...
//Crea el array en forma de grids
pokemons.forEach(pokemon => {
    ...
    if(random_number==1){
        ...
        if(pokemon.name=="Nidoran♀"){
            img.src = "https://projectpokemon.org/images/shiny-sprite/nidoran_f.gif";
            img.alt = pokemon.name;
        }
        else if(pokemon.name=="Nidoran♂"){
            img.src = "https://projectpokemon.org/images/shiny-sprite/nidoran_m.gif";
            img.alt = pokemon.name;
        }
        else if(pokemon.name=="Mr. Mime"){
            img.src = "https://projectpokemon.org/images/normal-sprite/mr.mime.gif";
            img.alt = pokemon.name;
        }
        else if(pokemon.name=="Farfetch’d"){
            img.src = "https://projectpokemon.org/images/shiny-sprite/farfetchd.gif";
            img.alt = pokemon.name;
        }
        else{
            img.src = "https://projectpokemon.org/images/shiny-sprite/"+pokemon.name.toLowerCase()+".gif";
            img.alt = pokemon.name;
        }
